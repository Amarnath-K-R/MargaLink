...
export type Book = {
  ...
  // Where the checkpoint pin goes (book-local): the top of the right page by
  // the spine, close to the edge the path slips under.
...
export function buildBook(THREE: T, kit: Kit): Book {
  ...
  return { group, pinSpot: new THREE.Vector3(0.9, TOP, -PD / 2 + 0.35), setProgress };
}
